...
"[project]/src/app/api/fetchProducts/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        const response = await fetch(url, {
            headers: {
                Authorization: `Bearer ${("TURBOPACK compile-time value", "<Z9YdP5jrvgq26RlVjWdSlUwEFsmRmVwmlC2MGWOR>")}`
            }
        });
        if (!response.ok) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fad065._.js.map